                ...
                <div class="card-body">
                    ...
                    <form method="POST" enctype="multipart/form-date">
                        ...
                        <div class="form-group">
                            ...
                            <input type="numbers" placeholder="Número de participantes" name="capacity" class="form-control" required></input>
                        </div>
                        <div class="buttons-container">
                            @csrf

                            <a href="{{ route('aprende') }}">
                            <button type="button" class="button-access buttonBack">
                                {{ __('Atrás') }}
                            </button>
                            </a>
